                            ...
                            <tr>
                                ...
                                <td class="bgLtRow1 padded optArea">
                                    <select style="width:166px;" id="sort" name="sort">
                                        ...
                                        <option @selected(MiscHelper::getSortType($inputs["sort"]) === "3") value="3">Def</option>
                                        <option @selected(MiscHelper::getSortType($inputs["sort"]) === "4") value="4">MDef</option>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="bgLtRow1 padded optArea">
                                    ...
                                    <input type="text" style="width:100px;" id="def" name="def" value="{{ MiscHelper::getDataValue($inputs["def"], 0)  }}">
                                    <span class="extraText" id="defExtra" style="visibility: hidden;">
                                        and <input type="text" style="width:100px;" id="def2" name="def2" value="{{ MiscHelper::getDataValue($inputs["def"], 1)  }}">
                                    </span>
                            ...
                            <tr>
                                ...
                                <td class="bgLtRow2 padded optArea">
                                    ...
                                    <input type="text" style="width:100px;" id="mdef" name="mdef" value="{{ MiscHelper::getDataValue($inputs["mdef"], 0)  }}">
                                    <span class="extraText" id="mdefExtra" style="visibility: hidden;">
                                        and <input type="text" style="width:100px;" id="mdef2" name="mdef2" value="{{ MiscHelper::getDataValue($inputs["mdef"], 1)  }}">
                                    </span>
                                    <script type="text/javascript">
                                        adjustAttrText('mdef');
                                    </script>
