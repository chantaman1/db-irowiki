                            ...
                            <tr>
                                ...
                                <td class="bgLtRow1 padded optArea">
                                    <select style="width:166px;" id="sort" name="sort">
                                        ...
                                        <option @selected(MiscHelper::getSortType($inputs["sort"]) === "2") value="2">Weight</option>
                                        <option @selected(MiscHelper::getSortType($inputs["sort"]) === "3") value="3">Req'd Level</option>
                                        <option @selected(MiscHelper::getSortType($inputs["sort"]) === "4") value="4">HP</option>
                                        <option @selected(MiscHelper::getSortType($inputs["sort"]) === "5") value="5">SP</option>
                                        <option @selected(MiscHelper::getSortType($inputs["sort"]) === "6") value="6">Price</option>
                                    </select>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="bgLtRow1 padded optArea">
                                    ...
                                    <input type="text" style="width:100px;" id="hp" name="hp" value="{{ MiscHelper::getDataValue($inputs["hp"], 0)  }}">
                                    <span class="extraText" id="hpExtra" style="visibility: hidden;">
                                        and <input type="text" style="width:100px;" id="hp2" name="hp2" value="{{ MiscHelper::getDataValue($inputs["hp"], 1)  }}">
                                    </span>
                            ...
                            <tr>
                                ...
                                <td class="bgLtRow2 padded optArea">
                                    <select style="width:80px;" id="spCon" name="spCon" onchange="adjustAttrText('reqlv');">
                                        <option @selected(MiscHelper::getOperationType($inputs["sp"]) === "1") value="1">=</option>
                                        <option @selected(MiscHelper::getOperationType($inputs["sp"]) === "2") value="2">&gt;</option>
                                        <option @selected(MiscHelper::getOperationType($inputs["sp"]) === "3") value="3">&lt;</option>
                                        <option @selected(MiscHelper::getOperationType($inputs["sp"]) === "4") value="4">&gt;=</option>
                                        <option @selected(MiscHelper::getOperationType($inputs["sp"]) === "5") value="5">&lt;=</option>
                                        <option @selected(MiscHelper::getOperationType($inputs["sp"]) === "6") value="6">Between</option>
                                    </select>
                                    <input type="text" style="width:100px;" id="sp" name="sp" value="{{ MiscHelper::getDataValue($inputs["sp"], 0)  }}">
                                    <span class="extraText" id="spExtra" style="visibility: hidden;">
                                        and <input type="text" style="width:100px;" id="sp2" name="sp2" value="{{ MiscHelper::getDataValue($inputs["sp"], 1)  }}">
                                    </span>
                                    <script type="text/javascript">
                                        adjustAttrText('sp');
                                    </script>
                            ...
                            <tr>
                                ...
                                <td class="bgLtRow2 padded optArea">
                                    <select style="width:80px;" id="priceCon" name="priceCon" onchange="adjustAttrText('reqlv');">
                                        <option @selected(MiscHelper::getOperationType($inputs["price"]) === "1") value="1">=</option>
                                        <option @selected(MiscHelper::getOperationType($inputs["price"]) === "2") value="2">&gt;</option>
                                        <option @selected(MiscHelper::getOperationType($inputs["price"]) === "3") value="3">&lt;</option>
                                        <option @selected(MiscHelper::getOperationType($inputs["price"]) === "4") value="4">&gt;=</option>
                                        <option @selected(MiscHelper::getOperationType($inputs["price"]) === "5") value="5">&lt;=</option>
                                        <option @selected(MiscHelper::getOperationType($inputs["price"]) === "6") value="6">Between</option>
                                    </select>
                                    <input type="text" style="width:100px;" id="price" name="price" value="{{ MiscHelper::getDataValue($inputs["price"], 0)  }}">
                                    <span class="extraText" id="priceExtra" style="visibility: hidden;">
                                        and <input type="text" style="width:100px;" id="price2" name="price2" value="{{ MiscHelper::getDataValue($inputs["price"], 1)  }}">
                                    </span>
                                    <script type="text/javascript">
